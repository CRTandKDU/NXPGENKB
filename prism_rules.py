...
class PrismRules:
    ...
    def __get_rule_str( self, target_col, target_val, terms_list,
                        num_rows_curr_target, num_rows_curr_target_remaining,
                        df_full, rule_df, is_first_rule ):
    ...
    def __get_rules_for_target_val(self, df_full, target_col, target_val, fmt='PRISM'):
        """
        ...
        while target_val_remaining > self.min_coverage:
            ...
            if( 'PRISM' == fmt ):
                rule_str = self.__get_rule_str( target_col, target_val, terms_list,
                                                num_rows_curr_target, num_rows_curr_target_remaining,
                                                df_full, rule_df, is_first_rule )
            elif ('NXP40Y' == fmt ):
                rule_str = nxp.nxp_prism_rule( target_col, target_val, terms_list, self )
            else:
                rule_str = ""
            #
            is_first_rule = False
